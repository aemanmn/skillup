...
import aboutImg from "../components/assets/images/about.jfif"
          ...
          <div className='heading w-4/5 md:w-full'>
            ...
            <ul className='my-5'>
              ...
              <li className='text-sm flex items-center gap-5 my-2'>
                ...
                Access more then 10K online courses
              </li>
              <li className='text-sm flex items-center gap-5'>
                <AiOutlineCheck className='text-green-500' />
                Learn the  skills in demand
              </li>
            </ul>
            <button className='px-5 py-2 border border-purple-300 rounded-md text-sm'>Apply Now</button>
          </div>
        </div>
      </div>
    </section>
